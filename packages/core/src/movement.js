...
import { directionStep, faceClosestToOrigin, footprintEquals, priorityDirections, rectsAdjacent, tileRect, } from './geometry.js';
...
function tryDisplaceOneCell(grid, victimId, priorityDirs, originRect, ignore) {
...
function pushChainInfinite(grid, tileId, target, dir) {
    ...
    const { dx, dy } = directionStep(dir);
    const safety = 10000; // guard against pathological infinite loops
